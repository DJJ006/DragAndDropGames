...
public class TransformationScript : MonoBehaviour
{
    ...
    void Update()
    {
        if(objScript.lastDragged != null)
        {
            ...
            {
                objScript.lastDragged.GetComponent<RectTransform>().transform.Rotate(0, 0, Time.deltaTime * 45f);
            }
            ...
            {
                if(objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.y < 2f)
                {
            ...
            {
                if (objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x < 1f)
                {
                    objScript.lastDragged.GetComponent<RectTransform>().transform.localScale =
                        new Vector3(
                            objScript.lastDragged.GetComponent<RectTransform>().transform.localScale.x + 0.005f,
